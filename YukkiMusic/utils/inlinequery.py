...
answer.extend(
    [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent("سلمي اص"),
        ),
        InlineQueryResultArticle(
            title="إلغاء الكتم",
            description=f"لالغاء كتم الحساب المساعد",
            thumb_url="https://telegra.ph/file/3078794f9341ffd582e18.png",
            input_message_content=InputTextMessageContent("سلمي تكلمي"),
        ),
        InlineQueryResultArticle(
            title="التخطي",
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent("سلمي طفيها"),
        ),
        InlineQueryResultArticle(
            title="تكرار التشغيل",
