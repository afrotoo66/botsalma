...
async def musicme(client, message):
       ...
       if message.chat.id not in disable:
         ...
         url = f"https://t.me/T_Y_E_X/{rl}"
         await message.reply_voice(url,caption="-› [• property sꪖlmꪖ 𓏣 •](t.me/T_Y_E_X)")
...
async def ava(client, message):
       ...
       if message.chat.id not in disable_A:
         ...
         url = f"https://t.me/T_Y_E_X/{rl}"
         await message.reply_photo(url,caption="-› [• property sꪖlmꪖ 𓏣 •](t.me/T_Y_E_X)")
...
async def qw2(client,message):
       ...
       if message.chat.id not in disable_G:
         ...
         url = requests.get(f"https://t.me/T_Y_E_X/{rl}").text
